...
from .types import FloatMtx, NumArr
...
def bin_kmeans_mean_multiclass(
    ...
    assigns each sample to a cluster based on means of k-means clusters of the scores.
...
def bin_kmeans_centroid_multiclass(
    ...
    """
    A k-means based binarization function for multiclass classification.
    assigns each sample to a cluster based on the centroids of k-means clusters of the scores.
...
def sklearn_wrap_multiclass[T: HasFitBinClass](Z: FloatMtx, V: np.ndarray, model: T) -> tuple[NumArr, T]:
