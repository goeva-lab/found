...
# for example, this is used by the {py:func}`~found.methods.score_null_dist` function to rerun the pipeline regression step on randomly permuted case labels to approximate a "null" p_hat distribution.
#
