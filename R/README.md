...
found can be installed via the following command using the [`pak`](https://pak.r-lib.org/#arrow_down-installation) library:
...
documentation can then be built using the following R commands
